...
export default function AdminProfile() {
  ...
  const save = useMutation({
    mutationFn: adminApiService.updateProfile,
    onSuccess: () => {
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit(d => save.mutate(d))} className="space-y-6">
        <div className="card-glass p-6 space-y-4">
          <h2 className="font-semibold text-white flex items-center gap-2"><User size={16} className="text-brand-400" /> Identidade</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">Título profissional *</label>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 pt-6">
              <input type="checkbox" id="available" {...register('available')} className="w-4 h-4 accent-brand-500" />
              <label htmlFor="available" className="text-sm text-slate-300">Disponível para projetos</label>
            </div>
          </div>
        </div>
        ...
        <div className="card-glass p-6 space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">URL do Currículo (PDF)</label>
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">Website pessoal</label>
